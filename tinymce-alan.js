...
(function () {
  ...
  var getPos = function (body, elm, rootElm) {
    ...
    if (elm) {
      if (rootElm === body && elm.getBoundingClientRect && $_amfzy311jd09esju.get($_cld8qzyjd09esjm.fromDom(body), 'position') === 'static') {
        ...
        x = pos.left + scrollleft - doc.documentElement.clientLeft;
        y = pos.top + scrolltop - doc.documentElement.clientTop;
  ...
  var EditorObservable = {
    ...
    unbindAllNativeEvents: function () {
      ...
      if (!self.inline) {
        //self.getBody().onload = null; // modify by alantypoon 20180517
        var mybody = self.getBody();
        if (mybody){
          mybody.onload = null;
        }
