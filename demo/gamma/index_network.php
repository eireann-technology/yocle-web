<div id="div_ntwk">
	<table id="tbl_ntwk" cellspacing="0" cellpadding="0" width="100%">
			...
			<td class="layout_box" style="width:100%">
				<table width="100%" border="0">
					<tr>
						...
						<td align="right" class="text_syncwith">
							Sync with
						</td>
						<td width="80">
							<table cellspacing="3">
		...
		<tr>
			<td>
				<div class="layout_box">
					<span class="text_invitemyntwk invite_button">Invite people to my network</span>
					<table>
						<tr>
							<td>
		...
		<tr>
			<td>
				<div class="layout_box">
					<span class="text_mycurrntwk">My current network</span>
