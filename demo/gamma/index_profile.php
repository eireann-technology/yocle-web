				...
				<tr>
					...
					<td valign="top" style="padding-right:10px;">
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td>
									<br/><b class="text_skillstbl">Skills Table</b><br/>
									...
									<tr>
										...
										<td valign="top">
											...
											<table style="width:100%; height:100%; border:1px solid #e0e0e0; margin-top:8px;">
												<tr>
													<td>
														<input type="radio" name="profile_priv" checked disabled /><span class="text_public"></span>
													</td>
												</tr>
												<tr>
													<td>
														<input type="radio" name="profile_priv" disabled /><span class="text_onlyntwk"></span>
													</td>
												</tr>
												<tr>
													<td>
														<input type="radio" name="profile_priv" disabled /><span class="text_private"></span>
													</td>
												</tr>
											</table>
