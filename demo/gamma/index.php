...
<!--	<link rel="stylesheet" href="./font-awesome-4.6.3/css/font-awesome.css">-->
	<script>
		...
		var cssfiles = ''
				...
				,jsfiles = ''
											+ 'index.js svg.js data.js lang.js'
		;
...
<ul id="dropmenu_action" class="dropmenu" style="width:120px; text-align:left">
	...
	<li>
		<a href="#search_gsstatus" class="dropmenu-item text_showgsstatus" nowrap>Show GS Status</a>
	</li>
</ul>
...
<div id="dialog_gsstatus" class="adialog" title="People">
	<?php include "./search_gsstatus.php"?>
</div>
