					...
					<td width="100%">
						<table width="100%" border="0">
							<tr>
								...
								<td class="headerx" style="text-align:left">
									Question
								</td>
								<td class="headerx multiple_choice">
									Answer
								</td>
								<td class="headerx assessment_weight">
									Weight%
								</td>
								<td class="td_delete">
									&nbsp;
							...
							<tr>
								...
								<td colspan="4">
									<table width="100%" border="0">
										<tr>
											<td colspan="2">
												<textarea class="ta_question editor" rows="1">What are the differences between living in Taiwan and South Korea? (1000 words)</textarea>
											</td>
											<td class="multiple_choice">
											</td>
											<td class="assessment_weight">
												<input class="assessment_spinner" value="60" style="width:25px"/>											
											</td>
											<td class="td_delete" valign="top">
												<button class="icon_button but_trash"></button>
											</td>
