...
function initAll(){
	...
	$('.toggle_impression').on('toggle', function(e, active) {
...
$('.toggle_comment')
	...
	g_chart_samson1 = initRadarChart($('#canvas_samson1'), $('#tbl_gs_samson1'), gs_samson, config_samson, 7);
	g_chart_samson2 = initRadarChart($('#canvas_samson2'), $('#tbl_gs_samson2'), gs_samson, config_samson, 12, 1);
