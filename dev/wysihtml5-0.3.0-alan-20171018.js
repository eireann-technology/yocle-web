...
rangy.createModule("WrappedSelection", function(b, c) {
    ...
    s.areHostMethods(t, ["addRange", "getRangeAt", "removeAllRanges"]) && ("number" == typeof t.rangeCount && b.features.implementsDomRange) && function() {
        ...
        b.open();
        //b.write("<html><head></head><body></body></html>"); // alantypoon 20170629
        b.close();
...
(function(b) {
    ...
    b.Selection = Base.extend({
        ...
        getSelection: function() {
            return rangy.getNativeSelection(this.doc.defaultView ||
                this.doc.parentWindow)
        },
        setSelection: function(a) {
            //return rangy.getNativeSelection(this.doc.defaultView || this.doc.parentWindow).setSingleRange(a)
            var output = null;
            var sel = rangy.getNativeSelection(this.doc.defaultView || this.doc.parentWindow);
            if (sel && sel.setSingleRange){
                output = sel.setSingleRange(a);
            }
            return output;
        }
    })
...
(function(b, c) {
    ...
    f.prototype = {
        ...
        undoToTextNode: function(b,
            c, e) {
            //c.containsNode(e) || (b = c.cloneRange(), b.selectNode(e), b.isPointInRange(c.endContainer, c.endOffset) && a(c.endContainer, c.endOffset) && (d(e, c.endContainer, c.endOffset), c.setEndAfter(e)), b.isPointInRange(c.startContainer, c.startOffset) && a(c.startContainer, c.startOffset) && (e = d(e, c.startContainer, c.startOffset))); // alantypoon
            (b = c.cloneRange(), b.selectNode(e), b.isPointInRange(c.endContainer, c.endOffset) && a(c.endContainer, c.endOffset) && (d(e, c.endContainer, c.endOffset), c.setEndAfter(e)), b.isPointInRange(c.startContainer, c.startOffset) && a(c.startContainer, c.startOffset) && (e = d(e, c.startContainer, c.startOffset))); // alantypoon
        ...
        applyToRange: function(a) {
            ...
            //var c = a.getNodes([b.TEXT_NODE]); // alantypoon 20171018
            var c = [];
        ...
        undoToRange: function(a) {
            //var c = a.getNodes([b.TEXT_NODE]), d, e; // alantypoon
            var c = [], d, e;
        ...
        isAppliedToRange: function(a) {
            var c = [], d, e = [];
                //e = a.getNodes([b.TEXT_NODE]); // alantypoon 20171018
                // a.getNodes is not a function
