...
class Swift_Signers_SMimeSignerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject3')
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject4')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
...
OEL;
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject5')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
...
OEL;
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject6')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject7')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
...
OEL;
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject8')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject9')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject10')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
...
OEL;
    ...
    {
        $message = Swift_SignedMessage::newInstance('Wonderful Subject11')
          ->setFrom(array('john@doe.com' => 'John Doe'))
          ->setTo(array('receiver@domain.org', 'other@domain.org' => 'A name'))
          ->setBody('Here is the message itself');
