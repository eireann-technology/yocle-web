...
"use strict";
  ...
  var Resumable = function(opts){
						...
						if (status == 'success' || status == 'error') {
							...
							if (output){
								if (output.error){
									...
									console.info('resummable:doneHandler', 'media_id='+output.media.media_id);	// alantypoon 20161026
    ...
    $.uploadNextChunk = function(){
      ...
      if(!outstanding) {
         console.info('file complete', this.uid);
