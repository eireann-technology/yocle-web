...
<html dir="ltr" lang="en-US">
   <head>
      ...
      function PDFViewerPlugin() {
          ...
          this.showPage = function(b) {
              a.isSlideshow() ? (c[A - 1].style.display = "none", A = b, s(e[b - 1]), c[b - 1].style.display = "block") :
                (b = c[b - 1],
                //b.parentNode.scrollTop = b.offsetTop,  // cancelled by alantypoon
								b.parentNode.scrollTop = b.offsetTop - 20,  // modified by alantypoon
                1
            )
          };
          this.getPluginName = function() {
      ...
      function Viewer(b, r) {
          ...
          (function() {
              ...
              }), document.addEventListener("fullscreenchange", B), document.addEventListener("webkitfullscreenchange", B), document.addEventListener("mozfullscreenchange", B), document.addEventListener("MSFullscreenChange", B), p("download", g.download), p("zoomOut", g.zoomOut), p("zoomIn", g.zoomIn), p("previous", g.showPreviousPage), p("next", g.showNextPage), p("previousPage", g.showPreviousPage), p("nextPage", g.showNextPage),
      ...
      <div id = "viewer">
         ...
         <div id = "toolbarContainer" >
            <div id = "toolbar">
               ...
               <div id="toolbarRight">
                  <button id = "download" class = "toolbarButton download" title="Download" stylexxx="display:none;"></button>
               </div>
            </div>
         </div>
         <div id = "canvasContainer" style="top:0px; bottom:0px;">
            <div id = "canvas"></div>
         </div>
         <div id = "overlayNavigator" style="display:none">
            <div id = "previousPage"></div>
            <div id = "nextPage"></div>
         </div>
         <div id = "overlayCloseButton" style="display:none">
            &#10006;
         </div>
         <div id = "dialogOverlay" style="display:none"></div>
         <div id = "blanked" style="display:none"></div>
      </div>
   </body>
</html>
